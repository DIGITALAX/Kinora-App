    ...
    <div className="relative w-full h-fit flex flex-col gap-3 items-center justify-center text-white">
      <div className="relative flex w-full h-full overflow-y-scroll">
        <div className="relative flex flex-col w-full h-fit justify-start items-start gap-3">
          <div className="relative w-fit h-fit break-words font-vcr text-gray-300 text-xxs flex items-center justify-center text-center">
          ...
          <div className="relative w-full h-fit inline-flex flex-wrap gap-1.5 items-center justify-center">
            <input
              placeholder="name"
              className="bg-black border h-8 border-moda p-1.5 font-vcr text-white text-xs rounded-sm"
            ...
            <input
              placeholder="zip"
              className="bg-black border border-moda p-1.5 font-vcr w-16 text-white text-xs h-8 rounded-sm"
            ...
            <input
              placeholder="city"
              className="bg-black border border-moda p-1.5 font-vcr w-20 text-white text-xs h-8 rounded-sm"
