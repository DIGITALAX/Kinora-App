...
const Footer: FunctionComponent<{ router: NextRouter }> = ({ router }) => {
  return (
    <div className="fixed w-full h-20 bottom-0 bg-black flex flex-row items-center justify-center">
      {[
        "#0F121A",
        "#FE0000",
        "#FE8000",
        ...
        return (
          ...
          >
            {index == 0 && (
              <div
                className="relative w-14 h-8 flex items-center justify-center cursor-pointer active:scale-95"
                onClick={() => router.push("/")}
              >
                <Image
