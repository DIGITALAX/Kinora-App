...
export const getAllCollections = async (
  ...
  const queryPromise = graphPrintClient.query({
    ...
    query($first: Int, $skip: Int, $title: String, $dropTitle: String) {
      collectionCreateds(where: { and: [{collectionMetadata_: { title_starts_with_nocase: $title }}, {collectionMetadata_: { title_end_with_nocase: $title }}, {dropMetadata_: { dropTitle_contains_nocase: $dropTitle }}]}}, first: $first, skip: $skip, orderDirection: desc, orderBy: blockTimestamp) {
        collectionId
        dropMetadata {
          dropCover
          dropTitle
